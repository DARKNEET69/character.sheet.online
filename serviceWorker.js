...
precacheAndRoute([{ url: "https://darkneet69.github.io/character.sheet.online/offline.html", revision: null }]);
...
setCatchHandler(async ({ event }) => {
    ...
    if (event.request.destination === "document") {
        return matchPrecache("https://darkneet69.github.io/character.sheet.online/offline.html");
    }
